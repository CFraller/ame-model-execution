 ...
 * </p>
 * <ul>
 *   <li>{@link ozobot.xdsml.ozobotl.model.impl.WaitImpl#getTime <em>Time</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WaitImpl extends CommandImpl implements Wait {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.WAIT;
	}
	...
	public void setTime(int newTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.WAIT__TIME, oldTime, time));
	}
