 ...
 * </p>
 * <ul>
 *   <li>{@link ozobot.xdsml.ozobotl.model.impl.MoveImpl#getDistance <em>Distance</em>}</li>
 *   <li>{@link ozobot.xdsml.ozobotl.model.impl.MoveImpl#getVelocity <em>Velocity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MoveImpl extends CommandImpl implements Move {
	...
	public void setDistance(int newDistance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MOVE__DISTANCE, oldDistance, distance));
	}
	...
	public void setVelocity(Velocity newVelocity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.MOVE__VELOCITY, oldVelocity, velocity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.MOVE__DISTANCE:
				return getDistance();
			case ModelPackage.MOVE__VELOCITY:
				return getVelocity();
		}
