...
public class LightAspect extends CommandAspect {
  ...
  public static void sendCommand(final Light _self, final MqttClient client) {
    final ozobot.k3dsa.LightAspectLightAspectProperties _self_ = ozobot.k3dsa.LightAspectLightAspectContext.getSelf(_self);
     if (_self instanceof ozobot.model.Light){
    					fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand command = new fr.inria.diverse.k3.al.annotationprocessor.stepmanager.StepCommand() {
    						@Override
    						public void execute() {
    							ozobot.k3dsa.LightAspect._privk3_sendCommand(_self_, (ozobot.model.Light)_self,client);
    						}
    					};
  ...
  private static void super_sendCommand(final Light _self, final MqttClient client) {
  ...
  protected static void _privk3_sendCommand(final LightAspectLightAspectProperties _self_, final Light _self, final MqttClient client) {
    try {
