 ...
 * </p>
 * <ul>
 *   <li>{@link ozobot.model.impl.CommandImpl#getOutgoing <em>Outgoing</em>}</li>
 *   <li>{@link ozobot.model.impl.CommandImpl#getIncoming <em>Incoming</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CommandImpl extends NamedElementImpl implements Command {
		...
		if (outgoing != null && outgoing.eIsProxy()) {
			...
			if (outgoing != oldOutgoing) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.COMMAND__OUTGOING,
	...
	public NotificationChain basicSetOutgoing(Transition newOutgoing, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModelPackage.COMMAND__OUTGOING, oldOutgoing, newOutgoing);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setOutgoing(Transition newOutgoing) {
		if (newOutgoing != outgoing) {
			...
			if (outgoing != null)
				msgs = ((InternalEObject) outgoing).eInverseRemove(this, ModelPackage.TRANSITION__SOURCE,
						Transition.class, msgs);
			if (newOutgoing != null)
				msgs = ((InternalEObject) newOutgoing).eInverseAdd(this, ModelPackage.TRANSITION__SOURCE,
						Transition.class, msgs);
			msgs = basicSetOutgoing(newOutgoing, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COMMAND__OUTGOING, newOutgoing,
					newOutgoing));
	}
	...
	public Transition getIncoming() {
		if (incoming != null && incoming.eIsProxy()) {
			...
			if (incoming != oldIncoming) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.COMMAND__INCOMING,
	...
	public NotificationChain basicSetIncoming(Transition newIncoming, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					ModelPackage.COMMAND__INCOMING, oldIncoming, newIncoming);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setIncoming(Transition newIncoming) {
		if (newIncoming != incoming) {
			NotificationChain msgs = null;
			if (incoming != null)
				msgs = ((InternalEObject) incoming).eInverseRemove(this, ModelPackage.TRANSITION__TARGET,
						Transition.class, msgs);
			if (newIncoming != null)
				msgs = ((InternalEObject) newIncoming).eInverseAdd(this, ModelPackage.TRANSITION__TARGET,
						Transition.class, msgs);
			msgs = basicSetIncoming(newIncoming, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COMMAND__INCOMING, newIncoming,
					newIncoming));
	}
