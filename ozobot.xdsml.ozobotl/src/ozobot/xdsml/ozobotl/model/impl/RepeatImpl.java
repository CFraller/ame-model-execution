...
public class RepeatImpl extends CommandImpl implements Repeat {
	...
	public NotificationChain basicSetBlock(Block newBlock, NotificationChain msgs) {
		...
		block = newBlock;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.REPEAT__BLOCK, oldBlock, newBlock);
	...
	public void setBlock(Block newBlock) {
		if (newBlock != block) {
			...
			if (block != null)
				msgs = ((InternalEObject)block).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ModelPackage.REPEAT__BLOCK, null, msgs);
			if (newBlock != null)
				msgs = ((InternalEObject)newBlock).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ModelPackage.REPEAT__BLOCK, null, msgs);
