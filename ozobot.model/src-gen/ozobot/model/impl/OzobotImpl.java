 ...
 *   <li>{@link ozobot.model.impl.OzobotImpl#getXposition <em>Xposition</em>}</li>
 *   <li>{@link ozobot.model.impl.OzobotImpl#getYposition <em>Yposition</em>}</li>
 *   <li>{@link ozobot.model.impl.OzobotImpl#getOrientation <em>Orientation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OzobotImpl extends NamedElementImpl implements Ozobot {
	...
	public void setXposition(float newXposition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.OZOBOT__XPOSITION, oldXposition,
					xposition));
	}
	...
	public void setYposition(float newYposition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.OZOBOT__YPOSITION, oldYposition,
					yposition));
	}
	...
	public void setOrientation(float newOrientation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.OZOBOT__ORIENTATION, oldOrientation,
					orientation));
	}
