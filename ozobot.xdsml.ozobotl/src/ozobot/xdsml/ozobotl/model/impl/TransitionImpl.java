 ...
 * </p>
 * <ul>
 *   <li>{@link ozobot.xdsml.ozobotl.model.impl.TransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link ozobot.xdsml.ozobotl.model.impl.TransitionImpl#getTarget <em>Target</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends NamedElementImpl implements Transition {
	...
	public NotificationChain basicSetSource(Command newSource, NotificationChain msgs) {
		...
		source = newSource;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSITION__SOURCE, oldSource, newSource);
	...
	public void setSource(Command newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, ModelPackage.COMMAND__OUTGOING, Command.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, ModelPackage.COMMAND__OUTGOING, Command.class, msgs);
	...
	public NotificationChain basicSetTarget(Command newTarget, NotificationChain msgs) {
		...
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSITION__TARGET, oldTarget, newTarget);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTarget(Command newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, ModelPackage.COMMAND__INCOMING, Command.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, ModelPackage.COMMAND__INCOMING, Command.class, msgs);
			msgs = basicSetTarget(newTarget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.TRANSITION__TARGET, newTarget, newTarget));
	}
