 ...
 * </p>
 * <ul>
 *   <li>{@link ozobot.model.impl.RotateImpl#getDirection <em>Direction</em>}</li>
 *   <li>{@link ozobot.model.impl.RotateImpl#getVelocity <em>Velocity</em>}</li>
 *   <li>{@link ozobot.model.impl.RotateImpl#getAngle <em>Angle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RotateImpl extends CommandImpl implements Rotate {
	...
	public void setDirection(Direction newDirection) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ROTATE__DIRECTION, oldDirection,
					direction));
	}
	...
	public void setVelocity(Velocity newVelocity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.ROTATE__VELOCITY, oldVelocity,
					velocity));
	}
