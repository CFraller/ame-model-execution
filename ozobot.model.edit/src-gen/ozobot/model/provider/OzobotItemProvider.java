...
/**
 * This is the item provider adapter for a {@link ozobot.model.Ozobot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OzobotItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public OzobotItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.OZOBOT__PROGRAMS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Ozobot"));
	}
	...
	public String getText(Object object) {
		String label = ((Ozobot) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Ozobot_type")
				: getString("_UI_Ozobot_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ModelPackage.Literals.OZOBOT__PROGRAMS,
				ModelFactory.eINSTANCE.createOzobotProgram()));
	}
